...
#define tg1 (table)
#define tg2 (table+256)
#define tg3 (table+256*2)
#define tg4 (table+256*3)
...
#define round(a,b,c,x,mul) \
      c ^= x; \
      a -= tg1[((c)>>(0*8))&0xFF] ^ tg2[((c)>>(2*8))&0xFF] ^ \
	   tg3[((c)>>(4*8))&0xFF] ^ tg4[((c)>>(6*8))&0xFF] ; \
      b += tg4[((c)>>(1*8))&0xFF] ^ tg3[((c)>>(3*8))&0xFF] ^ \
	   tg2[((c)>>(5*8))&0xFF] ^ tg1[((c)>>(7*8))&0xFF] ; \
      b *= mul;
#else
...
#define round(a,b,c,x,mul) \
      c ^= x; \
      a -= tg1[(byte)(c)] ^ \
           tg2[(byte)(((word32)(c))>>(2*8))] ^ \
	   tg3[(byte)((c)>>(4*8))] ^ \
           tg4[(byte)(((word32)((c)>>(4*8)))>>(2*8))] ; \
      b += tg4[(byte)(((word32)(c))>>(1*8))] ^ \
           tg3[(byte)(((word32)(c))>>(3*8))] ^ \
	   tg2[(byte)(((word32)((c)>>(4*8)))>>(1*8))] ^ \
           tg1[(byte)(((word32)((c)>>(4*8)))>>(3*8))]; \
      b *= mul;
#endif
