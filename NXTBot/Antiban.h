...
struct antiban
{
	...
	static bool long_break_manager(float min = 50.0f, float max = 300.0f, float min_break = 3.0f, float max_break = 15.0f);
	static bool short_break_manager(float min = 15.0f, float max = 50.0f, float min_break = 0.08f, float max_break = 2.5f);
};
